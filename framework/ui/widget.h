...
inline uint32_t ui_get_spec_mode(uint32_t spec) { return spec & UI_SPEC_MODE_MASK; }
inline uint32_t ui_get_spec_size(uint32_t spec) { return spec & ~UI_SPEC_MODE_MASK; }
inline uint32_t ui_make_spec(uint32_t mode, uint32_t size) { return mode | size; }
